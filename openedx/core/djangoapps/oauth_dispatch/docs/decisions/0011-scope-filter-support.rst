...
* :ref:`Include Organizations in Tokens`, where we decided to include a `content_org` filter in JWT tokens.
...
Using the example from :ref:`Include Organizations in Tokens`, we would now simply use the Application Access admin screen to set::
